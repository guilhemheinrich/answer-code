...
shinyServer(function(input, output) {
 ...
 # input$study_object_label, input$variable
  observeEvent(input$go, {
    ...
    future({
      connectToOpenSILEXWS(username = "admin@opensilex.org", password = "admin", url = "http://www.opensilex.org:8080/weisAPI/rest/", reconnection = TRUE)
    ...
    future({
      connectToOpenSILEXWS(username = "admin@opensilex.org", password = "admin",
                           url = "http://www.opensilex.org:8080/weisAPI/rest/", reconnection = TRUE)
